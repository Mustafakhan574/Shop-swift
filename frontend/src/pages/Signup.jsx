  ...
  return (
    <div className='w-[100vw] h-[100vh] text-white flex flex-col items-center justify-start bg-[#000000aa]'>
         ...
         <div className='max-w-[700px] w-[90%] h-[500px] bg-[#00000025] border-[1px] border-[#96969635] rounded-lg flex items-center justify-center'>
                 <form action="" onSubmit={handlesignup} className='w-[90%] h-[90%] flex flex-col justify-start items-center gap-[20px]'>
                    <div className='w-[90%] h-[50px] rounded-lg flex items-center justify-center gap-[10px] py-[20px] cursor-pointer bg-[#00ffffb6]' onClick={googlesignup}>
                              <img src={google} alt="" className='w-[20px] '/>
                              <p className=' font-bold'>Signup with Google</p>
                    </div>
                   ...
                   <input type="text" className='w-[100%] h-[50px] border-[2px] border-[#96969635] rounded-lg shadow-lg bg-transparent px-[20px] font-semibold placeholder-[#ffffffc7]'placeholder='Username' required onChange={(e)=>setname(e.target.value)} value={name}/>
                   ...
                   <button className='w-[100%] h-[50px] bg-[aqua] rounded-lg flex items-center justify-center mt-[20px] text-[17px] font-medium'>Signup</button>
                   <p className='flex gap-[10px]'>have any account? <span className='text-[#5555f6cf] text-[17px] font-semibold'onClick={()=>navigate("/login")}>
                    Login
                    </span>
                    </p>
                    </div>
